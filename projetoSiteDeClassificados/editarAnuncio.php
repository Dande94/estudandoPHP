...
if(isset($_POST['tituloAnuncio']) && !empty($_POST['tituloAnuncio'])){
    ...
    $a->editAnuncio($catAnuncio, $tituloAnuncio, $descAnuncio, $precoAnuncio, $estadoAnuncio, $_GET['id']);
    ?>
...
if(isset($_GET['id']) && !empty($_GET['id'])){
    ...
    ?>
        <script type="text/javascript">window.location.href="meusAnuncios.php.php"</script>
    <?php
}
